...
const MatchCard: React.FC<{
  ...
  if (!prediction) {
    return (
      <div
        ref={cardRef}
        className="bg-card/50 border border-dashed border-border/50 rounded-lg p-3 w-64 min-h-[100px] flex flex-col items-center justify-center text-center relative z-10"
      >
  ...
  const getTeamClasses = (alliance: "red" | "blue") => {
    let classes =
      "p-2 rounded-md transition-all border-2 flex justify-between items-center ";
  ...
  return (
    <div
      ref={cardRef}
      className="bg-card border border-border rounded-lg p-3 w-64 shadow-lg shadow-black/30 relative z-10"
    >
        ...
        <div className={getTeamClasses("red")}>
          <div className="flex items-center gap-2">
            ...
            <div className="font-mono text-red-300">
              {prediction.team_keys.red
                .map((t) => t.replace("frc", ""))
                .join(" ")}
            </div>
          </div>
          <span className="font-bold text-red-300 w-8 text-right">
            {prediction.actual_scores?.red ?? prediction.predicted_scores.red}
          </span>
        </div>
        <div className={getTeamClasses("blue")}>
          <div className="flex items-center gap-2">
            ...
            <div className="font-mono text-blue-300">
              {prediction.team_keys.blue
                .map((t) => t.replace("frc", ""))
                .join(" ")}
            </div>
          </div>
          <span className="font-bold text-blue-300 w-8 text-right">
            {prediction.actual_scores?.blue ?? prediction.predicted_scores.blue}
          </span>
        </div>
      </div>
    </div>
...
const FinalsCard: React.FC<{
  ...
  return (
    <div
      ref={cardRef}
      className="bg-card border-2 border-accent/50 rounded-lg p-4 w-64 shadow-xl shadow-black/40 flex items-center gap-4 relative z-10"
    >
      <div className="flex-grow">
        <h4 className="text-base font-bold text-accent text-center mb-2">
          FINALS
        </h4>
        <div className="flex flex-col gap-1">
          ...
          >
            {finalMatch1
              ? `Blue: ${finalMatch1.team_keys.blue
                  .map((t) => t.replace("frc", ""))
                  .join(" ")}`
              : "Winner of M13"}
          </div>
...
export const PlayoffBracket: React.FC<{ predictions: Prediction[] }> = ({
  predictions,
}) => {
  ...
  if (playoffMatchesByKey.size === 0) {
    return (
      <div className="bg-card border border-border rounded-xl p-8 text-center text-text-muted">
        ...
        <p>Playoff bracket will be shown here once matches are generated.</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex justify-center items-start overflow-x-auto p-4 lg:p-6 bg-card border border-border rounded-xl">
      ...
      >
        <div
          ref={gridRef}
          className="grid gap-x-8 gap-y-2 relative"
          style={{
            gridTemplateColumns: "30px repeat(6, 256px)",
            gridTemplateRows: "30px repeat(14, auto)",
            minWidth: "1650px",
          }}
        >
          <LineDrawer
          ...
          />
          <div
            className="text-accent font-bold text-sm tracking-widest flex items-center justify-center [writing-mode:vertical-rl]"
            style={{ gridRow: "2 / span 7" }}
          >
            UPPER BRACKET
          </div>
          <div
            className="text-accent font-bold text-sm tracking-widest flex items-center justify-center [writing-mode:vertical-rl]"
            style={{ gridRow: "9 / span 6" }}
          >
            LOWER BRACKET
          </div>
          <h3
            className="text-text-muted font-bold text-center"
            style={{ gridColumn: 2 }}
          >
            ROUND 1
          </h3>
          ...
          {/* Round 1 (Upper) */}
          <div
            style={{ gridArea: "2 / 2 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 1"
              cardRef={setMatchRef("M1")}
              placeholderText="Alliance 1 vs Alliance 8"
              prediction={findMatch(`${eventKey}_sf1m1`)}
            />
          </div>
          <div
            style={{ gridArea: "4 / 2 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 2"
              cardRef={setMatchRef("M2")}
              placeholderText="Alliance 4 vs Alliance 5"
              prediction={findMatch(`${eventKey}_sf2m1`)}
            />
          </div>
          <div
            style={{ gridArea: "6 / 2 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 3"
              cardRef={setMatchRef("M3")}
              placeholderText="Alliance 3 vs Alliance 6"
              prediction={findMatch(`${eventKey}_sf3m1`)}
            />
          </div>
          <div
            style={{ gridArea: "8 / 2 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 4"
              cardRef={setMatchRef("M4")}
              placeholderText="Alliance 2 vs Alliance 7"
              prediction={findMatch(`${eventKey}_sf4m1`)}
            />
          </div>

          {/* Round 2 (Upper & Lower) */}
          <div
            style={{ gridArea: "3 / 3 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 7"
              cardRef={setMatchRef("M7")}
              placeholderText="Winner M1 vs Winner M2"
              prediction={findMatch(`${eventKey}_sf7m1`)}
            />
          </div>
          <div
            style={{ gridArea: "7 / 3 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 8"
              cardRef={setMatchRef("M8")}
              placeholderText="Winner M3 vs Winner M4"
              prediction={findMatch(`${eventKey}_sf8m1`)}
            />
          </div>
          <div
            style={{ gridArea: "10 / 3 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 5"
              cardRef={setMatchRef("M5")}
              placeholderText="Loser M1 vs Loser M2"
              prediction={findMatch(`${eventKey}_sf5m1`)}
            />
          </div>
          <div
            style={{ gridArea: "12 / 3 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 6"
              cardRef={setMatchRef("M6")}
              placeholderText="Loser M3 vs Loser M4"
              prediction={findMatch(`${eventKey}_sf6m1`)}
            />
          </div>

          {/* Round 3 (Lower) */}
          <div
            style={{ gridArea: "9 / 4 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 9"
              cardRef={setMatchRef("M9")}
              placeholderText="Loser M7 vs Winner M6"
              prediction={findMatch(`${eventKey}_sf9m1`)}
            />
          </div>
          <div
            style={{ gridArea: "11 / 4 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 10"
              cardRef={setMatchRef("M10")}
              placeholderText="Loser M8 vs Winner M5"
              prediction={findMatch(`${eventKey}_sf10m1`)}
            />
          </div>

          {/* Round 4 (Upper Final & Lower) */}
          <div
            style={{ gridArea: "5 / 5 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 11"
              cardRef={setMatchRef("M11")}
              placeholderText="Winner M9 vs Winner M10"
              prediction={findMatch(`${eventKey}_sf11m1`)}
            />
          </div>
          <div
            style={{ gridArea: "10 / 5 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 12"
              cardRef={setMatchRef("M12")}
              placeholderText="Winner M7 vs Winner M8"
              prediction={findMatch(`${eventKey}_sf12m1`)}
            />
          </div>

          {/* Round 5 (Lower Final) */}
          <div
            style={{ gridArea: "8 / 6 / span 2 / span 1" }}
            className="flex items-center"
          >
            <MatchCard
              title="Match 13"
              cardRef={setMatchRef("M13")}
              placeholderText="Loser M12 vs Winner M11"
              prediction={findMatch(`${eventKey}_sf13m1`)}
            />
          </div>

          {/* Finals */}
          <div
            style={{ gridArea: "6 / 7 / span 2 / span 1" }}
            className="flex items-center"
          >
            <FinalsCard
              cardRef={setMatchRef("FINALS")}
